<div class="section" id="section3">
    <div class="intro fulscreenbug" id="background3">
        <h1 class="invisible" id="date2"></h1><br><br>
        <div class="container-fluid">

            <!----------------------------------------------MENU----------------------------------------------->
            <div class="row">
                <div class="col-md-6 riba">        
                    
<select class="btn btn-default dropdown-toggle dropdown" id="miestai" name="fetchby">
...
<select class="btn btn-default dropdown-toggle dropdown" id="tipas" name="fetchby2" placeholder="hey">
