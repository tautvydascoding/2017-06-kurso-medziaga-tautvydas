...
echo "<h2>Laiskas siunciamas, aciu uz jusu laiska.</h2>";
...
$mail->setFrom('nerijuscustrans@gmail.com', 'Nerijus');
$mail->addAddress('nerijuscustrans@gmail.com', 'Nerijus');     // Add a recipient
