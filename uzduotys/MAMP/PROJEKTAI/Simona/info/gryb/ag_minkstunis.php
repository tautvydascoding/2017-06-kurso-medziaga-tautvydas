          ...
          <div class="col-xs-9">
            <div class="remelis2">
              <div class="row-snd">
                <div class="col-xs-4">
                  <div class="article">
                    <h4>Juosvasis minkštūnis</h4>
                    <h5><i> Melanoleuca turrita (Fr.) Singer </i></h5><br /><br />
                    <p>
Statusas. ¡ Lietuvos raudon‡j‡ knyg‡ r ̊ is ·ra yta nuo 2000 m.
Paplitimas. Europoje, –iaurÎs Afrikoje.
Lietuvoje  ̨inoma 1 radavietÎ MinËios apylinkÎse (Ute- nos r.).
Biologija ir ekologija. Saprotrofas. Auga vasar‡ ir ru- den· mi riuose ir spygliuoËi ̄ mi kuose. MÎgsta tur- ting‡ maisto med ̨iag ̄ dirvo ̨em·. –iltesnio klimato zonose auga plaËialapi ̄ med ̨i ̄ ñ buk ̄, ‡ ̨uol ̄ arba mi riuose mi kuose.
Populiacij ̄ gausumas. –iuo metu Lietuvoje  ̨inoma 1 populiacija.
GrÎsmÎs ir apsauga. Sen ̄ med ̨i ̄ kirtimas, retinimas, dÎl kuri ̄ pakinta augavieËi ̄ medyn ̄ sudÎtis ir struk- t ̊ra, dirvo ̨emio savybÎs, mikroklimatas.
                          </p>
                  </div>
                </div>
                <div class="col-xs-4">
