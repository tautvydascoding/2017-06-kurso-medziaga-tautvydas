      ...
      <div class="row1">
        ...
        <!-- RODYKLINIS MENIU -->
          <div class="col-xs-1">
            <div class="row-frst">
              <ul>
                <h4><ins> Vorai </ins></h4><br>
                <li><a href="av_vor_bor.php"><h5>Boružinis storagalvis</h5>
                </a></li><br>
                <li><a href="av_vor_plud.php"><h5>Didysis plūdvoris</h5>
                </a></li><br>
          ...
          <div class="col-xs-9">
            <div class="remelis2">
              <div class="row-snd">
                <div class="col-xs-4">
                  <div class="article">
                    <h4>Boružinis storagalvis</h4>
                    <h5><i> Cerastium brachypetalum </i></h5><br /><br />
                    <p>
Statusas. Á Lietuvos raudonàjà knygà rûðis áraðyta nuo 1989 m.<br>
Paplitimas. Vakarø, Vidurio ir Pietø Europoje, Kau- kaze, Kryme.<br>
