          ...
          <div class="col-xs-9">
            <div class="remelis2">
              <div class="row-snd">
                <div class="col-xs-4">
                  <div class="article">
                    <h4>Mažasis baublys</h4>
                    <h5><i> Ixobrychus minutus </i></h5><br /><br />
                    <p>
Statusas. ¡ Lietuvos raudon‡j‡ knyg‡ r ̊ is ·ra yta nuo 1989 m.
¡ra yta · Berno konvencijos II, Bonos konvencijos II, AEWA II priedus ir Pauk Ëi ̄ direktyvos I pried‡.
Paplitimas. Eurazijoje nuo PirÎn ̄ pusiasalio ir rytinÎs Baltijos pakrantÎs iki ObÎs baseino ir Nepalo. –iaurÎje iki Sankt Peterburgo gubernijos, ObÎs auk tupio. Pietuose iki Ma ̨osios Azijos, Vidur ̨emio j ̊ros pakranËi ̄.
Apie r ̊ ies paplitim‡ Lietuvoje duomen ̄ nedaug. Per paskutinius 30 met ̄ i nyko Bir ̨ulio ir Stervo pelki ̄ komplekse, fiuvinto rezervate, ElektrÎn ̄ vandens sau- gykloje, Meteli ̄ e ̨ere, Vilniaus apylinkÎse. Paskutiniu metu aptikta tik NovaraisËio ir Baltosios VokÎs durpy- nuose, Baltosios VokÎs ir Arvyd ̄  ̨uvininkystÎs tvenki- niuose, Kauno mariose, Nemuno deltoje.
Biologija ir ekologija. Peri nedideliuose vandens telki- niuose (karjeruose,  ̨uvininkystÎs tvenkiniuose, k ̊dro- se), apaugusiuose antvandenine augalija, kr ̊mais. Sun- kiai pastebimas pauk tis, nes juda laipiodamas augali- jos stiebais ir retai rodosi atviroje aplinkoje. Aktyvus nakt· ir sutemus.
                    </p>
                  </div>
                </div>
                <div class="col-xs-4">
