...
// uzduotis: sukurti klases "Gyvunas", "Tipas" - kuri paveldi Gyvunas, "Liutas" - kuri paveldi Tipas
    ...
    echo "Ardis vardas: " . $Ardis->getName() . "<br />";
      $Ardis->setName("Ardukas");
    echo "Ardis vardas:" . $Ardis->getName(). "<br />";
        ...
        class User   {
          ...
          public function Login ($name, $pass) {
              if ($this->usernamer == "name" && $this->password == $pass) {
                echo "Welcome back!";
              }else{
        ...
        // kuriam Admino objektą
        $Adminas = new Admin();
        echo "Username is : $Adminas->username" . "<br />";
        $Adminas->changeUserName = "Tomas" . "<br />";
        echo "Username is $Adminas->changeUserName";


if ($Adminas = "Tomas") {
  echo "The dog was found!";
    }else{
